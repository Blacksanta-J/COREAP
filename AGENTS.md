...
- Roles: **Admin** (all + manage users), **APEL** (Acto Público, Eleves Acto Público, Control POF, Manuales), **Concursos** (Eleves Concursos, Control POF, Manuales), **Usuarios** (Manuales only).
